...
- Реальное меню из CDR-макетов (~/Downloads/TG/Lokmaco*.cdr): 93 позиции, 15 категорий, 33 фото блюд.
...
- В макете режим 10:00-03:00 и обслуживание 15%, но для Ферганы оставлены данные Асиля (10:00-01:00, 10%).
