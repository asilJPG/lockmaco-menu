...
## Дополнительные правила разработки (system-prompt.md)

### Вывод
- Ответы краткие, строго по делу. Без вводных фраз вроде "Конечно!", "Отличный вопрос!".
- Код должен говорить сам за себя. Объяснения максимум 1-3 предложения.
- Показывать только измененные части кода в виде diff или фрагментов.

### Качество кода
- Никаких заглушек типа `// TODO` или `// implement here`. Код должен быть рабочим.
- Имена переменных должны быть понятными. Без `x`, `data2`, `temp`.

### Файловая организация
- Экспериментальные скрипты, тесты или временные файлы сохранять строго в папке `_tests/` в корне проекта (или в `scratch` папке артефактов).
